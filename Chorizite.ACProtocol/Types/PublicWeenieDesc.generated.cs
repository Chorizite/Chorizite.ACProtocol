...
namespace Chorizite.ACProtocol.Types {
    ...
    public class PublicWeenieDesc : IACDataType {
        ...
        /// object behaviors
        /// </summary>
        public ObjectDescriptionFlag Behavior;
        ...
        public void Read(BinaryReader reader) {
            ...
            Behavior = (ObjectDescriptionFlag)reader.ReadUInt32();
            ...
            if (((uint)Header & (uint)0x01000000) != 0) {
                Workmanship = reader.ReadSingle();
            }
            if (((uint)Header & (uint)0x00200000) != 0) {
                Burden = reader.ReadUInt16();
            }
            ...
            if (((uint)Header2 & (uint)0x00000001) != 0) {
                IconUnderlay = reader.ReadPackedDWORD();
            }
            if (((uint)Header & (uint)0x80000000) != 0) {
                Material = (MaterialType)reader.ReadUInt32();
            }
            if (((uint)Header2 & (uint)0x00000002) != 0) {
                CooldownId = reader.ReadUInt32();
            }
            if (((uint)Header2 & (uint)0x00000004) != 0) {
                CooldownDuration = reader.ReadUInt64();
            }
            if (((uint)Header2 & (uint)0x00000008) != 0) {
                PetOwnerId = reader.ReadUInt32();
            }
            if ((reader.BaseStream.Position % 4) != 0) {
                reader.BaseStream.Position += 4 - (reader.BaseStream.Position % 4);
            }
        ...
        public void Write(BinaryWriter writer) {
            ...
            if (((uint)Header2 & (uint)0x00000002) != 0) {
                writer.Write(CooldownId);
            }
            if (((uint)Header2 & (uint)0x00000004) != 0) {
                writer.Write(CooldownDuration);
            }
            if (((uint)Header2 & (uint)0x00000008) != 0) {
                writer.Write(PetOwnerId);
            }
            if ((writer.BaseStream.Position % 4) != 0) {
                writer.BaseStream.Position += 4 - (writer.BaseStream.Position % 4);
            }
